...
<section id="pricing" class="shop-section" data-aos="fade-up">
  ...
  <div class="pakot-grid">
    ...
    <div class="pako-card" data-aos="fade-up" data-aos-delay="0">
      <a href="/GYMWEBSITE-UEB26_GR23/pages/pakodiaspora.php" class="pako-link">
    ...
    <div class="pako-card" data-aos="fade-up" data-aos-delay="100">
      <a href="/GYMWEBSITE-UEB26_GR23/pages/1vitantarsim.php" class="pako-link">
        <img src="/GYMWEBSITE-UEB26_GR23/assets/fotot/1vitantarsim.png" alt="Oferta 1 vit / 2 persona">
      </a>
      ...
      <form method="POST">
        ...
        <input type="hidden" name="image" value="/GYMWEBSITE-UEB26_GR23/assets/fotot/1vitantarsim.png">
        <button type="submit" name="add_to_cart" class="pako-buton">Add To Cart</button>
      </form>
    </div>

    <div class="pako-card" data-aos="fade-up" data-aos-delay="200">
      <a href="/GYMWEBSITE-UEB26_GR23/pages/oferta3n1.php" class="pako-link">
    ...
    <div class="pako-card" data-aos="fade-up" data-aos-delay="300">
      <a href="/GYMWEBSITE-UEB26_GR23/pages/allacsses.php" class="pako-link">
        <img src="/GYMWEBSITE-UEB26_GR23/assets/fotot/allacsses.png" alt="All Club Access">
      </a>
